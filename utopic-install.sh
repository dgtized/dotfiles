...
curl --output clj.sh -O https://download.clojure.org/install/linux-install-1.10.3.1087.sh &&
...
wget https://github.com/babashka/babashka/releases/download/v0.7.7/babashka-0.7.7-linux-amd64.tar.gz -O babashka.tgz &&
