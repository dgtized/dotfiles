...
curl --output clj.sh -O https://download.clojure.org/install/linux-install-1.10.3.981.sh &&
...
wget https://github.com/babashka/babashka/releases/download/v0.6.0/babashka-0.6.0-linux-amd64.tar.gz -O babashka.tgz &&
