...
curl --output clj.sh -O https://download.clojure.org/install/linux-install-1.11.1.1105.sh &&
...
wget https://github.com/babashka/babashka/releases/download/v0.8.0/babashka-0.8.0-linux-amd64.tar.gz -O babashka.tgz &&
