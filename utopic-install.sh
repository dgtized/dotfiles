...
curl --output clj-linux-install.sh -O \
     https://download.clojure.org/install/linux-install-1.10.3.933.sh &&
...
wget https://github.com/babashka/babashka/releases/download/v0.5.0/babashka-0.5.0-linux-amd64.tar.gz -O babashka.tgz &&
