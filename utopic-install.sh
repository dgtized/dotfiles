...
curl --output clj.sh -O https://download.clojure.org/install/linux-install-1.10.3.1069.sh &&
...
wget https://github.com/babashka/babashka/releases/download/v0.7.4/babashka-0.7.4-linux-amd64.tar.gz -O babashka.tgz &&
